...
public class ReviewTest {
    ...
    public void getContent() {
        ...
        assertEquals("Satisfactory", testReview.getContent());
    }
    ...
    public void setContent() {
        ...
        assertNotEquals("Satisfactory", testReview.getContent());
    }

    @Test
    public void getWrittenBy() {
        Review testReview = setupReview();
        assertEquals("Chris", testReview.getWrittenBy());
    }

    @Test
    public void setWrittenBy() {
        Review testReview = setupReview();
        testReview.setWrittenBy("Danny");
        assertNotEquals("Chris", testReview.getWrittenBy());
    }
